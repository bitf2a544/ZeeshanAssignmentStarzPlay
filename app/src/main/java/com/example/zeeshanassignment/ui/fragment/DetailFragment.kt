...
import com.example.zeeshanassignment.databinding.FragmentCardBinding
import com.example.zeeshanassignment.utils.Constants
...
class DetailFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        carouselItemObj = arguments?.getParcelable(Constants.CARD_PARAM)!!
